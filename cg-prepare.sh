...
echo "text:Text/historical-post-truth-society.xhtml"
echo "cont:3:*:The Post-Truth Society"
echo "text:Text/historical-echo-chamber.xhtml"
echo "cont:3:*:The Echo Chambers"
echo "text:Text/historical-then-why.xhtml"
echo "cont:3:*:Why Then Algorithmic Rationalism"
